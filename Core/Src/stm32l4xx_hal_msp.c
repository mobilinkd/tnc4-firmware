...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(GPIOA, AUDIO_IN_Pin|AUDIO_AMP_Pin);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PB2     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = BAT_COMP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BAT_COMP_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PB2     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(BAT_COMP_GPIO_Port, BAT_COMP_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = AUDIO_OUT_Pin|DC_BIAS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, AUDIO_OUT_Pin|DC_BIAS_Pin);
