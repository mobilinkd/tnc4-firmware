...
typedef GPIO<(uint32_t)GPIOC_BASE,BT_STATE2_Pin> BT_STATE2_IN;
typedef GPIO<(uint32_t)GPIOB_BASE,BT_CMD1_Pin> BT_CMD1;
typedef GPIO<(uint32_t)GPIOC_BASE,BT_CMD2_Pin> BT_CMD2;
typedef GPIO<(uint32_t)GPIOC_BASE,BT_CMD3_Pin> BT_CMD3;
typedef GPIO<(uint32_t)GPIOD_BASE,BT_WAKE_Pin> BT_WAKE;
typedef GPIO<(uint32_t)GPIOC_BASE,BT_SLEEP_Pin> BT_SLEEP;
typedef GPIO<(uint32_t)GPIOB_BASE,BAT_CE_Pin> USB_CE;
typedef GPIO<(uint32_t)GPIOC_BASE,VDD_EN_Pin> VDD_ENABLE;
typedef GPIO<(uint32_t)GPIOB_BASE,BAT_DIV_Pin> BAT_DIVIDER;
typedef GPIO<(uint32_t)GPIOC_BASE,AUDIO_ATTEN_Pin> AUDIO_OUT_ATTEN;
typedef GPIO<(uint32_t)GPIOC_BASE,LED_TX_Pin> LED_TX;
typedef GPIO<(uint32_t)GPIOC_BASE,LED_RX_Pin> LED_RX;
typedef GPIO<(uint32_t)GPIOC_BASE,LED_BT_Pin> LED_BT;
